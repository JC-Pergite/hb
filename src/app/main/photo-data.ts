...
export class PhotoData implements InMemoryDbService {
	createDb() {
		let users = [
			{ id: 0, userName: 'Josh', avatarPic: '', albums: [ { id: 0, title: 'Voyages', 
																	photos: [ { id: 1, name: 'Aurora', type: 'Travel', photoUrl: 'https://i.ytimg.com/vi/HB74G1tD5XI/maxresdefault.jpg', comments: [] },
 																			  { id: 0, name: 'Bangkok', type: 'Travel', photoUrl: 'https://media-cdn.tripadvisor.com/media/photo-s/03/9b/2d/ad/bangkok.jpg', comments: [] }
																			],
 																},
															  ], comments: []
			}
		...
		return { users, photos, categories };
	}
}